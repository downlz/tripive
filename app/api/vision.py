...
@api_rest.route('/upload/readstorage/<string:resource_id>')          
class SecureVisionRed(Resource):
        def post(self, resource_id):
            data = {}
            client = vision.ImageAnnotatorClient()
            response = client.annotate_image({
        ...
        def get(self, resource_id):
            ...
            bucket = client.get_bucket('https://console.cloud.google.com/storage/browser/tripive.appspot.com')
            # Then do other things...
            blob = bucket.get_blob('/batch/output-1-to-1.json')
